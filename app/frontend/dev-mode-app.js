...
const LOCAL_DOCUMENTS = {
    '介绍文档': [
        ...
        "3) 📤 笔记共享：一键生成分享链接和二维码，轻松分享笔记内容",
        "4) 💡 知识库广场：汇聚各行业各学科优质笔记，支持个人知识库上传获取积分",
        "5) 📂 智能归类系统：根据内容自动判断主题，自动创建和管理 Markdown 章节结构",
        "6) 📊 智能总结：快速了解文档内容，说\"笔记里说了什么\"即可获得AI生成的总结",
        "7) ☁️ 云端永久存储：Cloudflare D1 持久化，跨设备访问",
        "8) 🔐 权限与只读保护：开发者模式、修改模式(set000)，只读文档防误改",
        "9) 👁️ 完整查看：弹窗滚动查看当前文档全部内容",
        "",
        "## 🧠 模型与选择",
        "",
        ...
        "4. 智能归类：直接说\"今天学了量子计算\"，系统会自动归类到\"物理\"主题下的\"量子计算\"章节",
        "5. 总结文档：说\"笔记里说了什么\"或\"总结一下\"快速了解文档内容",
        "6. 修改权限：输入 set000 开启修改；未开启时只读",
        "7. 开发者模式：输入 开发者模式#000 启用",
        "",
        "## 📌 注意事项",
        "",
...
function updateActiveDocTitle(title) {
    ...
    // 确保标题是有效的开发者模式文档
    const validDevDocs = ['介绍文档', '更新记录日志'];
